...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-7">
                            ...
                            <input
                                ...
                                class="border border-black rounded p-2 w-full"
                                name="title"
                                placeholder="Example: Audi 2020" value="<?php echo e(old('title')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-7">
                            ...
                            <input
                                ...
                                class="border border-black rounded p-2 w-full"
                                name="location"
                                placeholder="Example: Manchester, London, etc" value="<?php echo e(old('location')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-7">
                            ...
                            <input
                                ...
                                class="border border-black rounded p-2 w-full"
                                name="tags"
                                placeholder="Example: brand, year, colour, etc" value="<?php echo e(old('tags')); ?>"/>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/student/baguette_website/resources/views/listings/create.blade.php ENDPATH**/ ?>